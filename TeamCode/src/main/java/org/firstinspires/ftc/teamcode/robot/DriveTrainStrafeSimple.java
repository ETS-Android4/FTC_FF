...
public class DriveTrainStrafeSimple {
    ...
    public DriveTrainStrafeSimple() {
    }

    public void init(HardwareMap ahwMap, LinearOpMode opMode, String runeMode) {
        op_mode = opMode;
        hwMap = ahwMap;
        leftDriveFront = hwMap.get(DcMotor.class, "left_front");
        rightDriveFront = hwMap.get(DcMotor.class, "right_front");
        leftDriveBack = hwMap.get(DcMotor.class, "left_back");
        rightDriveBack = hwMap.get(DcMotor.class, "right_back");
